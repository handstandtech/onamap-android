package net.onamap.ui.model

import net.onamap.ui.R
...
object States {
    ...
    private fun put(abbv: String, name: String, drawableResThumb: Int, drawableRes: Int) {
        val stateData = StateData(abbv, name, drawableResThumb, drawableRes)
        s[abbv] = stateData
    }

    val map: Map<String, StateData>
        get() = s
